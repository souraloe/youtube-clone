...
class MenuBar: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override init(frame: CGRect) {
        ...
        collectionView.top(equalTo: self)
        collectionView.bottom(equalTo: self)
        collectionView.leading(equalTo: self)
        collectionView.trailing(equalTo: self)
...
class MenuCell: BaseCell {
    ...
    override func setupViews() {
        ...
        imageView.width(equalTo: 28)
        imageView.height(equalTo: 28)
        imageView.center(inside: self)
    }
}
